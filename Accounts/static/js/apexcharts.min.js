...
!(function (t, e) {
            ...
            },
            {
              ...
              value: function (t, e, i) {
                ...
                if ("square" === i.shape || "rect" === i.shape) {
                  ...
                  o.attr({ x: t - n / 2, y: e - n / 2, cx: t, cy: e, class: i.class ? i.class : "", fill: i.pointFillColor, "fill-opacity": i.pointFillOpacity ? i.pointFillOpacity : 1, stroke: i.pointStrokeColor, "stroke-width": i.pointStrokeWidth ? i.pointStrokeWidth : 0, "stroke-opacity": i.pointStrokeOpacity ? i.pointStrokeOpacity : 1 }), (s = o);
                } else ("circle" !== i.shape && i.shape) || (f.isNumber(e) || ((a = 0), (e = 0)), (s = this.drawCircle(a, { cx: t, cy: e, class: i.class ? i.class : "", stroke: i.pointStrokeColor, fill: i.pointFillColor, "fill-opacity": i.pointFillOpacity ? i.pointFillOpacity : 1, "stroke-width": i.pointStrokeWidth ? i.pointStrokeWidth : 0, "stroke-opacity": i.pointStrokeOpacity ? i.pointStrokeOpacity : 1 })));
                return s;
              },
            },
            {
        ...
        a(t, [
          {
            ...
            value: function (t, e, i) {
              ...
              if (((r = a.globals.gridHeight - o - parseFloat(t.label.style.fontSize) - t.marker.size), (n = a.globals.gridHeight - o), a.config.yaxis[t.yAxisIndex] && a.config.yaxis[t.yAxisIndex].reversed && ((r = o + parseFloat(t.label.style.fontSize) + t.marker.size), (n = o)), f.isNumber(s))) {
                var c = { pSize: t.marker.size, pointStrokeWidth: t.marker.strokeWidth, pointFillColor: t.marker.fillColor, pointStrokeColor: t.marker.strokeColor, shape: t.marker.shape, pRadius: t.marker.radius, class: "apexcharts-point-annotation-marker ".concat(t.marker.cssClass, " ").concat(t.id ? t.id : "") },
  ...
  var A = {
      ...
      options: {
        ...
        toolbar: { exportToSVG: "Download SVG", exportToPNG: "Download PNG", exportToCSV: "Download CSV", menu: "Menu", selection: "Selection", selectionZoom: "Selection Zoom", zoomIn: "Zoom In", zoomOut: "Zoom Out", pan: "Panning", reset: "Reset Zoom" },
      },
    },
    S = (function () {
      function t() {
        e(this, t),
          ...
          (this.pointAnnotation = {
            ...
            label: { borderColor: "#c2c2c2", borderWidth: 1, borderRadius: 2, text: void 0, textAnchor: "middle", offsetX: 0, offsetY: 0, style: { background: "#fff", color: void 0, fontSize: "11px", fontFamily: void 0, fontWeight: 400, cssClass: "", padding: { left: 5, right: 5, top: 2, bottom: 2 } } },
          ...
          (this.yAxisAnnotation = {
            ...
            width: "100%",
            yAxisIndex: 0,
            label: { borderColor: "#c2c2c2", borderWidth: 1, borderRadius: 2, text: void 0, textAnchor: "end", position: "right", offsetX: 0, offsetY: -3, style: { background: "#fff", color: void 0, fontSize: "11px", fontFamily: void 0, fontWeight: 400, cssClass: "", padding: { left: 5, right: 5, top: 2, bottom: 2 } } },
          }),
          (this.xAxisAnnotation = {
            ...
            offsetX: 0,
            offsetY: 0,
            label: { borderColor: "#c2c2c2", borderWidth: 1, borderRadius: 2, text: void 0, textAnchor: "middle", orientation: "vertical", position: "top", offsetX: 0, offsetY: 0, style: { background: "#fff", color: void 0, fontSize: "11px", fontFamily: void 0, fontWeight: 400, cssClass: "", padding: { left: 5, right: 5, top: 2, bottom: 2 } } },
          }),
          (this.text = { x: 0, y: 0, text: "", textAnchor: "start", foreColor: void 0, fontSize: "13px", fontFamily: void 0, fontWeight: 400, appendTo: ".apexcharts-annotations", backgroundColor: "transparent", borderColor: "#c2c2c2", borderRadius: 0, borderWidth: 0, paddingLeft: 4, paddingRight: 4, paddingTop: 2, paddingBottom: 2 });
      }
      return (
        a(t, [
          {
            ...
            value: function () {
              return {
                ...
                plotOptions: {
                  area: { fillTo: "origin" },
                  bar: { horizontal: !1, columnWidth: "70%", barHeight: "70%", distributed: !1, borderRadius: 0, rangeBarOverlap: !0, rangeBarGroupRows: !1, colors: { ranges: [], backgroundBarColors: [], backgroundBarOpacity: 1, backgroundBarRadius: 0 }, dataLabels: { position: "top", maxItems: 100, hideOverflowingLabels: !0, orientation: "horizontal" } },
                  ...
                  radialBar: {
                    ...
                    offsetX: 0,
                    offsetY: 0,
                    hollow: { margin: 5, size: "50%", background: "transparent", image: void 0, imageWidth: 150, imageHeight: 150, imageOffsetX: 0, imageOffsetY: 0, imageClipped: !0, position: "front", dropShadow: { enabled: !1, top: 0, left: 0, blur: 3, color: "#000", opacity: 0.5 } },
                ...
                fill: { type: "solid", colors: void 0, opacity: 0.85, gradient: { shade: "dark", type: "horizontal", shadeIntensity: 0.5, gradientToColors: void 0, inverseColors: !0, opacityFrom: 1, opacityTo: 1, stops: [0, 50, 100], colorStops: [] }, image: { src: [], width: void 0, height: void 0 }, pattern: { style: "squares", width: 6, height: 6, strokeWidth: 2 } },
                grid: { show: !0, borderColor: "#e0e0e0", strokeDashArray: 0, position: "back", xaxis: { lines: { show: !1 } }, yaxis: { lines: { show: !0 } }, row: { colors: void 0, opacity: 0.5 }, column: { colors: void 0, opacity: 0.5 }, padding: { top: 0, right: 10, bottom: 0, left: 12 } },
                labels: [],
                legend: {
                  show: !0,
                ...
                markers: { discrete: [], size: 0, colors: void 0, strokeColors: "#fff", strokeWidth: 2, strokeOpacity: 0.9, strokeDashArray: 0, fillOpacity: 1, shape: "circle", width: 8, height: 8, radius: 2, offsetX: 0, offsetY: 0, onClick: void 0, onDblClick: void 0, showNullDataPoints: !0, hover: { size: void 0, sizeOffset: 3 } },
                ...
                xaxis: {
                  ...
                  offsetX: 0,
                  offsetY: 0,
                  labels: { show: !0, rotate: -45, rotateAlways: !1, hideOverlappingLabels: !0, trim: !1, minHeight: void 0, maxHeight: 120, showDuplicates: !0, style: { colors: [], fontSize: "12px", fontWeight: 400, fontFamily: void 0, cssClass: "" }, offsetX: 0, offsetY: 0, format: void 0, formatter: void 0, datetimeUTC: !0, datetimeFormatter: { year: "yyyy", month: "MMM 'yy", day: "dd MMM", hour: "HH:mm", minute: "HH:mm:ss" } },
                  ...
                  crosshairs: { show: !0, width: 1, position: "back", opacity: 0.9, stroke: { color: "#b6b6b6", width: 1, dashArray: 3 }, fill: { type: "solid", color: "#B1B9C4", gradient: { colorFrom: "#D8E3F0", colorTo: "#BED1E6", stops: [0, 100], opacityFrom: 0.4, opacityTo: 0.5 } }, dropShadow: { enabled: !1, left: 0, top: 0, blur: 1, opacity: 0.4 } },
          ...
          },
          {
            ...
            value: function (t, e, i, a, s, r, n) {
              var o,
                ...
                v = g.fillPath({ seriesNumber: s, dataPointIndex: r, patternUnits: "objectBoundingBox", value: l.globals.series[s][n] });
              if (
                ("circle" === m.shape ? (o = f.drawCircle(i)) : ("square" !== m.shape && "rect" !== m.shape) || (o = f.drawRect(0, 0, m.width - m.pointStrokeWidth / 2, m.height - m.pointStrokeWidth / 2, m.pRadius)),
                l.config.series[h].data[r] && l.config.series[h].data[r].fillColor && (v = l.config.series[h].data[r].fillColor),
                o.attr({ x: t - m.width / 2 - m.pointStrokeWidth / 2, y: e - m.height / 2 - m.pointStrokeWidth / 2, cx: t, cy: e, fill: v, "fill-opacity": m.pointFillOpacity, stroke: m.pointStrokeColor, r: a, "stroke-width": m.pointStrokeWidth, "stroke-dasharray": m.pointStrokeDashArray, "stroke-opacity": m.pointStrokeOpacity }),
              ...
              if (!this.initialAnim || l.globals.dataChanged || l.globals.resized) l.globals.animationEnded = !0;
                ...
                c.animateMarker(o, 0, "circle" === m.shape ? a : { width: m.width, height: m.height }, w, l.globals.easing, function () {
              ...
              if (l.globals.dataChanged && "circle" === m.shape)
                if (this.dynamicAnim) {
                  ...
                  0 === t && 0 === e && (a = 0), c.animateCircle(o, { cx: k, cy: A, r: S }, { cx: t, cy: e, r: a }, T, l.globals.easing);
                } else o.attr({ r: a });
              return o.attr({ rel: r, j: r, index: s, "default-marker-size": a }), d.setSelectionFilter(o, s, r), u.addEvents(o), o.node.classList.add("apexcharts-marker"), o;
            },
          },
          {
        ...
        a(t, [
          {
            ...
            value: function (t, e, i, a, s, r, n) {
              var o = this.w,
                ...
                c = h.width,
                d = h.height;
              e < 0 && (e = 0), e > o.globals.gridHeight + d && (e = o.globals.gridHeight + d / 2), void 0 === o.globals.dataLabelsRects[a] && (o.globals.dataLabelsRects[a] = []), o.globals.dataLabelsRects[a].push({ x: t, y: e, width: c, height: d });
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (!(Array.isArray(e.config.dataLabels.enabledOnSeries) && e.config.dataLabels.enabledOnSeries.indexOf(r) < 0)) {
                ...
                ((("bar" === e.config.chart.type || "rangeBar" === e.config.chart.type) && e.config.plotOptions.bar.distributed) || e.config.dataLabels.distributed) && (m = e.globals.dataLabels.style.colors[n]), "function" == typeof m && (m = m({ series: e.globals.series, seriesIndex: r, dataPointIndex: n, w: e })), g && (m = g);
                var v = d.offsetX,
                  y = d.offsetY;
            ...
            value: function () {
              ...
              if ((l.config.plotOptions.bar.rangeBarGroupRows && (c = 1), this.barCtx.isHorizontal))
                ...
                if (((a = l.globals.gridWidth / this.barCtx.visibleItems), l.config.xaxis.convertedCatToNumeric && (a = l.globals.gridWidth / l.globals.dataPoints), (r = ((a / this.barCtx.seriesLen) * parseInt(this.barCtx.barOptions.columnWidth, 10)) / 100), l.globals.isXNumeric)) {
                  ...
                  l.config.xaxis.convertedCatToNumeric && (d = this.barCtx.initialXRatio), l.globals.minXDiff && 0.5 !== l.globals.minXDiff && l.globals.minXDiff / d > 0 && (a = l.globals.minXDiff / d), (r = ((a / this.barCtx.seriesLen) * parseInt(this.barCtx.barOptions.columnWidth, 10)) / 100) < 1 && (r = 1);
                }
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var x = e,
                m = e + i,
                v = d.line(a, m - r);
              return (f = f + d.line(u.x2, x) + u.pathWithRadius + d.line(u.x2, m - r) + v + v + "z"), (p = p + d.line(a, x) + v + v + v + v + v + d.line(a, x)), c.config.chart.stacked && (this.barCtx.xArrj.push(u.x2), this.barCtx.xArrjF.push(Math.abs(a - u.x2)), this.barCtx.xArrjVal.push(this.barCtx.series[l][h])), { pathTo: f, pathFrom: p };
            },
          },
          {
            key: "getRoundedBars",
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var P = new I(this).handleBarDataLabels({ x: c, y: d, y1: g, y2: u, i: r, j: s, series: f, realIndex: e, barHeight: p, barWidth: m, barYPosition: v, renderedPath: L, visibleSeries: w });
      ...
      return (
        a(t, [
          ...
          },
          {
            ...
            value: function (t) {
              return Date.parse(t.replace(/-/g, "https://coderthemes.com/").replace(/[a-z]+/gi, " "));
            },
          },
          {
            key: "formatDate",
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return f.extend(t, { grid: { show: !1, padding: { left: 0, right: 0, top: 0, bottom: 0 } }, legend: { show: !1 }, xaxis: { labels: { show: !1 }, tooltip: { enabled: !1 }, axisBorder: { show: !1 }, axisTicks: { show: !1 } }, chart: { toolbar: { show: !1 }, zoom: { enabled: !1 } }, dataLabels: { enabled: !1 } });
            },
          },
          {
            key: "bar",
          ...
          },
          {
            key: "area",
            value: function () {
              return { stroke: { width: 4 }, fill: { type: "gradient", gradient: { inverseColors: !1, shade: "light", type: "vertical", opacityFrom: 0.65, opacityTo: 0.5, stops: [0, 100, 100] } }, markers: { size: 0, hover: { sizeOffset: 6 } }, tooltip: { followCursor: !1 } };
            },
          },
          {
            key: "brush",
          ...
          },
          {
            ...
            value: function (t, e, i, a, s) {
              ...
              return t.config.series[e].type && t.config.series[e].type !== s
                ...
                : '<div class="apexcharts-tooltip-box apexcharts-tooltip-'.concat(t.config.chart.type, '">') + "<div>".concat(a[0], ': <span class="value">') + r + "</span></div>" + "<div>".concat(a[1], ': <span class="value">') + n + "</span></div>" + (o ? "<div>".concat(a[2], ': <span class="value">') + o + "</span></div>" : "") + "<div>".concat(a[3], ': <span class="value">') + l + "</span></div>" + "<div>".concat(a[4], ': <span class="value">') + h + "</span></div></div>";
            },
          },
        ]),
        t
        ...
        a(i, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ("bar" !== e.chart.type && "rangeBar" !== e.chart.type) || (e.tooltip.shared && "barWidth" === e.xaxis.crosshairs.width && e.series.length > 1 && (console.warn('crosshairs.width = "barWidth" is only supported in single series, not in a multi-series barChart.'), (e.xaxis.crosshairs.width = "tickWidth"))),
          ...
          },
          {
            ...
            value: function (t, e, i) {
              var a = this.w,
                ...
                h = [];
              if ("array" === t)
                if ((s && 6 === e[i].data[0].length) || (!s && 5 === e[i].data[0].length)) for (var c = 0; c < e[i].data.length; c++) r.push(e[i].data[c][1]), n.push(e[i].data[c][2]), s ? (o.push(e[i].data[c][3]), l.push(e[i].data[c][4]), h.push(e[i].data[c][5])) : (l.push(e[i].data[c][3]), h.push(e[i].data[c][4]));
              ...
              else if ("xy" === t) for (var g = 0; g < e[i].data.length; g++) Array.isArray(e[i].data[g].y) && (r.push(e[i].data[g].y[0]), n.push(e[i].data[g].y[1]), s ? (o.push(e[i].data[g].y[2]), l.push(e[i].data[g].y[3]), h.push(e[i].data[g].y[4])) : (l.push(e[i].data[g].y[2]), h.push(e[i].data[g].y[3])));
                        ...
                        if ((o.length && 0 === e && l.push(o.join(a)), t.data && t.data.length))
                          for (var s = 0; s < t.data.length; s++) {
                            ...
                            ("candlestick" === n.config.chart.type || (t.type && "candlestick" === t.type)) && (o.pop(), o.push(n.globals.seriesCandleO[e][s]), o.push(n.globals.seriesCandleH[e][s]), o.push(n.globals.seriesCandleL[e][s]), o.push(n.globals.seriesCandleC[e][s])),
                              ("boxPlot" === n.config.chart.type || (t.type && "boxPlot" === t.type)) && (o.pop(), o.push(n.globals.seriesCandleO[e][s]), o.push(n.globals.seriesCandleH[e][s]), o.push(n.globals.seriesCandleM[e][s]), o.push(n.globals.seriesCandleL[e][s]), o.push(n.globals.seriesCandleC[e][s])),
                ...
                s.globals.timescaleLabels.length
                  ...
                  : (s.globals.isXNumeric && (i = s.globals.xAxisScale.result.length),
                    ...
                    (function (t) {
                      ...
                      else for (var h = 0; h < a + (s.globals.isXNumeric ? 0 : 1); h++) 0 === h && 1 === a && 1 === s.globals.dataPoints && (o = r = s.globals.gridWidth / 2), e._drawGridLines({ i: h, x1: r, y1: n, x2: o, y2: l, xCount: i, parent: e.elgridLinesV }), (o = r += s.globals.gridWidth / (s.globals.isXNumeric ? a - 1 : a));
                    })({ xC: i, x1: n, y1: 0, x2: r, y2: o }));
              }
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                ...
                var a;
                if (
                  (void 0 === e.xaxis.tickAmount ? ((a = Math.round(t.svgWidth / 150)), "numeric" === e.xaxis.type && t.dataPoints < 30 && (a = t.dataPoints - 1), a > t.dataPoints && 0 !== t.dataPoints && (a = t.dataPoints - 1)) : "dataPoints" === e.xaxis.tickAmount ? (t.series.length > 1 && (a = t.series[t.maxValsInArrayIndex].length - 1), t.isXNumeric && (a = t.maxX - t.minX - 1)) : (a = e.xaxis.tickAmount),
                  (t.xTickAmount = a),
            ...
            value: function () {
              ...
              if (t.config.xaxis.crosshairs.show) {
                ...
                1 === t.config.xaxis.crosshairs.width && (w = e.drawLine()),
                  w.attr({ class: "apexcharts-xcrosshairs", x: 0, y: 0, y2: t.globals.gridHeight, width: f.isNumber(t.config.xaxis.crosshairs.width) ? t.config.xaxis.crosshairs.width : 0, height: t.globals.gridHeight, fill: y, filter: "none", "fill-opacity": t.config.xaxis.crosshairs.opacity, stroke: t.config.xaxis.crosshairs.stroke.color, "stroke-width": t.config.xaxis.crosshairs.stroke.width, "stroke-dasharray": t.config.xaxis.crosshairs.stroke.dashArray }),
                  ...
                  : ((e.globals.colors = e.config.colors),
                    Array.isArray(e.config.colors) &&
                      ...
                      (e.globals.colors = e.config.series.map(function (i, a) {
                        ...
                        return s || (s = e.config.colors[0]), "function" == typeof s ? ((t.isColorFn = !0), s({ value: e.globals.axisCharts ? (e.globals.series[a][0] ? e.globals.series[a][0] : 0) : e.globals.series[a], seriesIndex: a, dataPointIndex: a, w: e })) : s;
                      }))),
                ...
                e.config.yaxis.map(function (r, n) {
                  ...
                  if (!s.isYAxisHidden(n) && r.labels.show && o.result.length) {
                    ...
                    var u = new b(t.dCtx.ctx),
                      ...
                      m = x;
                    c !== d && (m = u.getTextRects(d, r.labels.style.fontSize, r.labels.style.fontFamily, p, !1)), i.push({ width: (m.width > x.width ? m.width : x.width) + a, height: m.height > x.height ? m.height : x.height });
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (this.dragged || null !== h.globals.selection) {
                ...
                h.globals.zoomEnabled && this.dragged && (a < 0 && (a = 1), c.attr({ x: e, y: i, width: a, height: s, fill: h.config.chart.zoom.zoomedArea.fill.color, "fill-opacity": h.config.chart.zoom.zoomedArea.fill.opacity, stroke: h.config.chart.zoom.zoomedArea.stroke.color, "stroke-width": h.config.chart.zoom.zoomedArea.stroke.width, "stroke-opacity": h.config.chart.zoom.zoomedArea.stroke.opacity }), b.setAttrs(c.node, g)),
                  h.globals.selectionEnabled && (d.attr({ x: e, y: i, width: a > 0 ? a : 0, height: s > 0 ? s : 0, fill: h.config.chart.selection.fill.color, "fill-opacity": h.config.chart.selection.fill.opacity, stroke: h.config.chart.selection.stroke.color, "stroke-width": h.config.chart.selection.stroke.width, "stroke-dasharray": h.config.chart.selection.stroke.dashArray, "stroke-opacity": h.config.chart.selection.stroke.opacity }), b.setAttrs(d.node, g));
              }
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                (g = "x" === i ? { x: l ? n - c : n, y: 0, width: c, height: a.globals.gridHeight } : "y" === i ? { x: 0, y: h ? o - d : o, width: a.globals.gridWidth, height: d } : { x: l ? n - c : n, y: h ? o - d : o, width: c, height: d }),
        ...
        a(t, [
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                r.globals.isXNumeric && ((m = (v = this.closestInMultiArray(g, u, y, b)).index), (p = v.j), null !== m && ((y = r.globals.seriesXvalues[m]), (p = (v = this.closestInArray(g, y)).index))),
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              (p && (p.innerHTML = void 0 !== h ? h : ""), u[0] && u[0].classList.contains("apexcharts-tooltip-marker") && (o.config.tooltip.marker.fillColors && Array.isArray(o.config.tooltip.marker.fillColors) && (n = o.config.tooltip.marker.fillColors[e]), (u[0].style.backgroundColor = n)), o.config.tooltip.marker.show || (u[0].style.display = "none"), null !== g) &&
                ((i[e].querySelector(".apexcharts-tooltip-text-z-label").innerHTML = o.config.tooltip.z.title), (i[e].querySelector(".apexcharts-tooltip-text-z-value").innerHTML = void 0 !== g ? g : ""));
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                (e.globals.isXNumeric ? ((n -= a % 2 != 0 ? l / 2 : 0), (r.classList.contains("apexcharts-candlestick-area") || r.classList.contains("apexcharts-boxPlot-area")) && e.globals.comboCharts && (n -= l / 2)) : e.globals.isBarHorizontal || ((n = i.xAxisTicksPositions[t - 1] + i.dataPointsDividedWidth / 2), isNaN(n) && (n = i.xAxisTicksPositions[t] - i.dataPointsDividedWidth / 2)),
                e.globals.isBarHorizontal ? (o += h / 3) : (o = i.e.clientY - c.top - i.tooltipRect.ttHeight / 2),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              null === n.tooltip && (n.tooltip = r.globals.dom.baseEl.querySelector(".apexcharts-tooltip")),
                ...
                !n.fixedTooltip &&
                  (!r.config.tooltip.shared || (r.globals.isBarHorizontal && n.tooltipUtil.hasBars())) &&
                ...
                var t = this.w,
                  ...
                  i = function (i) {
                    ...
                    null === t.globals.dom.baseEl.querySelector(".apexcharts-yaxistooltip apexcharts-yaxistooltip-".concat(i)) &&
                      ((e.yaxisTooltip = document.createElement("div")), e.yaxisTooltip.setAttribute("class", s + " apexcharts-theme-" + t.config.tooltip.theme), r.appendChild(e.yaxisTooltip), 0 === i && (e.yaxisTooltipText = []), (e.yaxisTooltipText[i] = document.createElement("div")), e.yaxisTooltipText[i].classList.add("apexcharts-yaxistooltip-text"), e.yaxisTooltip.appendChild(e.yaxisTooltipText[i]));
                  },
                  a = 0;
            ...
            value: function () {
              ...
              if (
                ...
                (s
                  ...
                  : a
                  ? (o = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series .apexcharts-bar-area, .apexcharts-series .apexcharts-candlestick-area, .apexcharts-series .apexcharts-boxPlot-area, .apexcharts-series .apexcharts-rangebar-area"))
        ...
        a(s, [
          ...
          },
          {
            ...
            value: function (t, e, i, a, s, r) {
              ...
              return (
                this.isHorizontal
                  ? ((n = ((n = a = l.globals.gridHeight / l.globals.dataPoints) * parseInt(l.config.plotOptions.bar.barHeight, 10)) / 100), (r = this.baseLineInvertedY + l.globals.padHorizontal + (this.isReversed ? l.globals.gridWidth : 0) - (this.isReversed ? 2 * this.baseLineInvertedY : 0)), (e = (a - n) / 2))
                  : ((o = i = l.globals.gridWidth / l.globals.dataPoints), (o = l.globals.isXNumeric && l.globals.dataPoints > 1 ? ((i = l.globals.minXDiff / this.xRatio) * parseInt(this.barOptions.columnWidth, 10)) / 100 : (o * parseInt(l.config.plotOptions.bar.columnWidth, 10)) / 100), (s = this.baseLineY[this.yaxisIndex] + (this.isReversed ? l.globals.gridHeight : 0) - (this.isReversed ? 2 * this.baseLineY[this.yaxisIndex] : 0)), (t = l.globals.padHorizontal + (i - o) / 2)),
        ...
        a(s, [
          {
            ...
            value: function (t, e) {
              ...
              for (
                var o = s.group({ class: "apexcharts-".concat(a.config.chart.type, "-series apexcharts-plot-series") }),
                  l = function (n) {
                    ...
                    var l,
                      ...
                      x = s.group({ class: "apexcharts-series", seriesName: f.escapeString(a.globals.seriesNames[p]), rel: n + 1, "data:realIndex": p });
                      ...
                      var y = s.group({ class: "apexcharts-datalabels", "data:realIndex": p }),
                        w = function (e) {
                          var s = i.barHelpers.getStrokeWidth(n, e, p),
                            o = i.drawBoxPaths({ indexes: { i: n, j: e, realIndex: p }, x: c, y: d, xDivision: l, barWidth: m, zeroH: h, strokeWidth: s, elSeries: x });
                          (d = o.y),
                            (c = o.x),
                            e > 0 && u.push(c + m / 2),
                            g.push(d),
                            o.pathTo.forEach(function (l, h) {
                              ...
                              i.renderSeries({ realIndex: p, pathFill: u, lineFill: g, j: e, i: n, pathFrom: o.pathFrom, pathTo: l, strokeWidth: s, elSeries: x, x: c, y: d, series: t, barHeight: b, barWidth: m, elDataLabelsWrap: y, visibleSeries: i.visibleI, type: a.config.chart.type });
                            });
                        },
                        k = 0;
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                (C = this.isBoxPlot
                  ? [l.move(S, w) + l.line(S + s / 2, w) + l.line(S + s / 2, v) + l.line(S + s / 4, v) + l.line(S + s - s / 4, v) + l.line(S + s / 2, v) + l.line(S + s / 2, w) + l.line(S + s, w) + l.line(S + s, A) + l.line(S, A) + l.line(S, w + n / 2), l.move(S, A) + l.line(S + s, A) + l.line(S + s, k) + l.line(S + s / 2, k) + l.line(S + s / 2, y) + l.line(S + s - s / 4, y) + l.line(S + s / 4, y) + l.line(S + s / 2, y) + l.line(S + s / 2, k) + l.line(S, k) + l.line(S, A) + "z"]
                  : [l.move(S, k) + l.line(S + s / 2, k) + l.line(S + s / 2, v) + l.line(S + s / 2, k) + l.line(S + s, k) + l.line(S + s, w) + l.line(S + s / 2, w) + l.line(S + s / 2, y) + l.line(S + s / 2, w) + l.line(S, w) + l.line(S, k - n / 2)]),
                (L += l.move(S, w)),
          ...
          },
          {
            ...
            value: function (t, e) {
              var i = this.w;
              return { o: this.isBoxPlot ? i.globals.seriesCandleH[t][e] : i.globals.seriesCandleO[t][e], h: this.isBoxPlot ? i.globals.seriesCandleO[t][e] : i.globals.seriesCandleH[t][e], m: i.globals.seriesCandleM[t][e], l: this.isBoxPlot ? i.globals.seriesCandleC[t][e] : i.globals.seriesCandleL[t][e], c: this.isBoxPlot ? i.globals.seriesCandleL[t][e] : i.globals.seriesCandleC[t][e] };
            },
          },
        ]),
        s
            ...
            value: function (t) {
              ...
              for (var h = o ? 0 : l.length - 1; o ? h < l.length : h >= 0; o ? h++ : h--) {
                ...
                for (var g = 0, u = e.config.plotOptions.heatmap.shadeIntensity, p = 0; p < l[h].length; p++) {
                  ...
                  var P = (0, e.config.dataLabels.formatter)(e.globals.series[h][p], { value: e.globals.series[h][p], seriesIndex: h, dataPointIndex: p, w: e }),
                    T = this.helpers.calculateDataLabels({ text: P, x: g + s / 2, y: n + r / 2, i: h, j: p, colorProps: y, series: l });
                  null !== T && c.add(T), (g += s);
                }
                (n += r), a.add(c);
              }
        ...
        a(t, [
            ...
            value: function (t, e) {
              ...
              for (var d = 0; d < t.length; d++) {
                ...
                var u = h < o ? this.fullAngle + h - o : h - o,
                  ...
                  v = s.drawPath({ d: m, stroke: Array.isArray(this.lineColorArr) ? this.lineColorArr[d] : this.lineColorArr, strokeWidth: 0, fill: p, fillOpacity: i.config.fill.opacity, classes: "apexcharts-pie-area apexcharts-".concat(this.chartType.toLowerCase(), "-slice-").concat(d) });
                ...
                var k = 0;
                if (
                  (!this.initialAnim || i.globals.resized || i.globals.dataChanged ? this.animBeginArr.push(0) : (0 === (k = (u / this.fullAngle) * i.config.chart.animations.speed) && (k = 1), (this.animDur = k + this.animDur), this.animBeginArr.push(this.animDur)),
                  this.dynamicAnim && i.globals.dataChanged ? this.animatePaths(v, { size: this.sliceSizes[d], endAngle: h, startAngle: o, prevStartAngle: l, prevEndAngle: c, animateStartingPos: !0, i: d, animBeginArr: this.animBeginArr, shouldSetPrevPaths: !0, dur: i.config.chart.animations.dynamicAnimation.speed }) : this.animatePaths(v, { size: this.sliceSizes[d], endAngle: h, startAngle: o, i: d, totalItems: t.length - 1, animBeginArr: this.animBeginArr, dur: k }),
          ...
          },
          {
            ...
            value: function (t, e, i, a, s, r) {
              ...
              l.globals.dataChanged && r.shouldSetPrevPaths && r.prevEndAngle && ((n = o.getPiePath({ me: o, startAngle: r.prevStartAngle, angle: r.prevEndAngle < r.prevStartAngle ? this.fullAngle + r.prevEndAngle - r.prevStartAngle : r.prevEndAngle - r.prevStartAngle, size: c })), t.attr({ d: n })),
                0 !== r.dur
                  ? t
          ...
          },
          {
            ...
            value: function (t) {
              var e = t.me,
                ...
                n = (Math.PI * (r - 90)) / 180,
                o = a + i;
              Math.ceil(o) >= this.fullAngle + (this.w.config.plotOptions.pie.startAngle % this.fullAngle) && (o = this.fullAngle + (this.w.config.plotOptions.pie.startAngle % this.fullAngle) - 0.01), Math.ceil(o) > this.fullAngle && (o -= this.fullAngle);
                ...
                t.forEach(function (t, o) {
                  ...
                  t.forEach(function (t, a) {
                    ...
                    if (d.enabled) {
                      ...
                      r.plotDataLabelsText({ x: g[a].x, y: g[a].y, text: f, textAnchor: "middle", i: o, j: o, parent: p, offsetCorrection: !1, dataLabelsConfig: n({}, d) });
                    }
                    h.add(p);
                  }),
                    s.push(h);
            ...
            value: function (t) {
              ...
              for (var m = p ? t.series.length - 1 : 0; p ? m >= 0 : m < t.series.length; p ? m-- : m++) {
                ...
                var y = a.fillPath({ seriesNumber: m, size: t.size, value: t.series[m] }),
                  ...
                  C = void 0;
                e.globals.dataChanged && ((k = this.startAngle), (C = Math.round((this.totalAngle * f.negToZero(e.globals.previousPaths[m])) / 100) + k)), Math.abs(S) + Math.abs(w) >= 360 && (S -= 0.01), Math.abs(C) + Math.abs(k) >= 360 && (C -= 0.01);
                var P = S - w,
                ...
                !this.initialAnim || e.globals.resized || e.globals.dataChanged || ((M = ((S - w) / 360) * e.config.chart.animations.speed), (this.animDur = M / (1.2 * t.series.length) + this.animDur), this.animBeginArr.push(this.animDur)),
                  ...
                  this.animatePaths(z, { centerX: t.centerX, centerY: t.centerY, endAngle: S, startAngle: w, prevEndAngle: C, prevStartAngle: k, size: t.size, i: m, totalItems: 2, animBeginArr: this.animBeginArr, dur: M, shouldSetPrevPaths: !0, easing: e.globals.easing });
              }
        ...
        a(t, [
          {
            ...
            value: function (t, e) {
              ...
              var y = this.timeScaleArray.map(function (t) {
                ...
                return "month" === t.unit ? n(n({}, e), {}, { day: 1, value: t.value + 1 }) : "day" === t.unit || "hour" === t.unit ? n(n({}, e), {}, { value: t.value }) : "minute" === t.unit ? n(n({}, e), {}, { value: t.value, minute: t.value }) : t;
              });
              ...
              s.series.map(function (e, g) {
                ...
                void 0 !== t[g].type
                  ? ("column" === t[g].type || "bar" === t[g].type
                      ? (s.series.length > 1 && a.plotOptions.bar.horizontal && console.warn("Horizontal bars are not supported in a mixed/combo chart. Please turn off `plotOptions.bar.horizontal`"), h.series.push(e), h.i.push(g), u++, (i.globals.columnSeries = h.series))
                      : "area" === t[g].type
        ...
        a(i, [
              ...
              r && (o = this.ctx.getSyncedCharts()),
                ...
                o.forEach(function (r) {
                  ...
                  return (
                    ...
                    e && "object" === t(e) && ((r.config = new D(e)), (e = y.extendArrayProps(r.config, e, o)), r.w.globals.chartID !== i.ctx.w.globals.chartID && delete e.series, (o.config = f.extend(o.config, e)), n && ((o.globals.lastXAxis = e.xaxis ? f.clone(e.xaxis) : []), (o.globals.lastYAxis = e.yaxis ? f.clone(e.yaxis) : []), (o.globals.initialConfig = f.extend({}, o.config)), (o.globals.initialSeries = f.clone(o.config.series)))),
                    r.update(e)
                  );
                });
            },
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              return (
                i.globals.axisCharts ? (a = i.globals.dom.Paper.select("".concat(s, " path[j='").concat(e, "'], ").concat(s, " circle[j='").concat(e, "'], ").concat(s, " rect[j='").concat(e, "']")).members[0]) : void 0 === e && ((a = i.globals.dom.Paper.select("".concat(s, " path[j='").concat(t, "']")).members[0]), ("pie" !== i.config.chart.type && "polarArea" !== i.config.chart.type && "donut" !== i.config.chart.type) || this.ctx.pie.pieClicked(t)),
            ...
            e &&
              ("string" == typeof e
                ? a.regex.isRgb.test(e)
                  ...
                  : a.regex.isHex.test(e) && ((i = a.regex.hex.exec(4 == (s = e).length ? ["#", s.substring(1, 2), s.substring(1, 2), s.substring(2, 3), s.substring(2, 3), s.substring(3, 4), s.substring(3, 4)].join("") : s)), (this.r = parseInt(i[1], 16)), (this.g = parseInt(i[2], 16)), (this.b = parseInt(i[3], 16)))
          ...
          extend: {
            ...
            step: function (t) {
              ...
              return (
                ...
                this.situation
                  ? (this.eachAt(), (1 == this.pos && !this.situation.reversed) || (this.situation.reversed && 0 == this.pos) ? (this.stopAnimFrame(), this.target().fire("finished", { fx: this, situation: this.situation }), this.situations.length || (this.target().fire("allfinished"), this.situations.length || (this.target().off(".fx"), (this.active = !1))), this.active ? this.dequeue() : this.clearCurrent()) : !this.paused && this.active && this.startAnimFrame(), (this.lastPos = s), this)
                  : this
              );
            },
            eachAt: function () {
      ...
      (function () {
        ...
        (t.prototype.transformPoint = function (t, e, i) {
          ...
          (t.prototype.snapToGrid = function (t, e, i, a) {
            var s;
            return (
              void 0 !== a ? (s = [(i + t) % this.options.snapToGrid, (a + e) % this.options.snapToGrid]) : ((i = null == i ? 3 : i), (s = [(this.parameters.box.x + t + (1 & i ? 0 : this.parameters.box.width)) % this.options.snapToGrid, (this.parameters.box.y + e + (2 & i ? 0 : this.parameters.box.height)) % this.options.snapToGrid])),
